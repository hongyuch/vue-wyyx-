    ...
    <div class="msite_header">
      ...
      <div class="nav-wrap">
        ...
        <div class="tabWrap" v-show="isShow">
          ...
          <div class="moreCate">
            <li class="cateTag" @click="addClass" v-for="(item, index) in listArr" :key="index">{{item}}</li>
          </div>
      ...
      <div class="msite_wrap">
        ...
        <div class="content_list">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <a href="javascript:;">
                <img src="./images/first/bao.png" alt />
                <span>新品首发</span>
              </a>
              <a href="javascript:;">
                <img src="./images/first/shenghuo.png" alt />
                <span>居家生活</span>
              </a>
              <a href="javascript:;">
                <img src="./images/first/yifu.png" alt />
                <span>服饰鞋包</span>
              </a>
              <a href="javascript:;">
                <img src="./images/first/meishi.png" alt />
                <span>美食酒水</span>
              </a>
              <a href="javascript:;">
                <img src="./images/first/jiadian.png" alt />
                <span>数码家电</span>
              </a>
              <a href="javascript:;">
                <img src="./images/first/bao.png" alt />
        ...
        <div class="shoppingGuide">
          <div class="shoppingGuide_wrap">
            <a href="javascript:;" class="styleBanner">
              <div class="styleBanner_top">
                <p class="title">9.9超值专区</p>
                <p class="text">190款商品定价直降</p>
              </div>
              <div class="styleBanner_bottom">
                <img src="./images/first/item01.png" alt />
                <img src="./images/first/item02.png" alt />
              </div>
            </a>
            <a href="javascript:;" class="styleBanner">
              <div class="styleBanner_top">
                <p class="title">50元内好物</p>
                <p class="text">买到生活小确信</p>
              </div>
              <div class="styleBanner_bottom">
                <img src="./images/first/item03.png" alt />
                <img src="./images/first/item01.png" alt />
              </div>
            </a>
            <a href="javascript:;" class="styleBanner">
              <div class="styleBanner_top">
                <p class="title">断货补单王</p>
                <p class="text">严选必买爆款</p>
              </div>
              <div class="styleBanner_bottom">
                <img src="./images/first/item01.png" alt />
                <img src="./images/first/item03.png" alt />
            ...
            <a href="javascript:;" class="styleBanner">
              <div class="styleBanner_top">
                <p class="title">家装换季</p>
                <p class="text">夏去秋来床品家装</p>
              </div>
              <div class="styleBanner_bottom">
                <img src="./images/first/item02.png" alt />
                <img src="./images/first/item01.png" alt />
...
export default {
  data() {
    return {
      listArr:["推荐","居家生活","服饰鞋包","美食酒水","个护清洁","母婴亲子","运动旅行","数码家电","全球特色"],
      isShow: false
    };
  },
  methods: {
